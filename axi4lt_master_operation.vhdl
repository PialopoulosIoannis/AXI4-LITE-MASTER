...
architecture behavioural of axi4_lite_master is
    ...
    signal buffer : std_logic_vector(NB_COL * COL_WIDTH - 1 downto 0) := (others => '0');
    signal buffer_ready : std_logic := '0';
    signal buffer_used : std_logic := '0';
