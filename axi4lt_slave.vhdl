...
architecture behavioural of axi4_lite_master is
    ...
    signal how_many_reads : integer;
    signal final_read : integer;
    signal bytes_in_int : integer;
    ...
    begin
        ...
        if areset_n = '0' then 
          ...
          case (state) is
           when IDLE =>   
                bytes_in_int:= to_integer(unsigned(lenght_in_bytes));
                how_many_read:= bytes_in_int div 4;
           ...
           when READ =>
            ...
            if s_axilt_rvalid = '1' and internal_rready = '1' then 
                ...
                if counter /= how_many_reads then
                    state <= READ;
                    s_axilt_araddr <= src_base_addr + counter*4;
